...
Процедура ВыполнитьАвтозаполнение() Экспорт 
	...
	Иначе 
		...
		|	ВКМ_ВыполненныеКлиентуРаботыОстаткиИОбороты.КоличествоЧасовРасход КАК ВсегоЧасов,
		|	ВКМ_ВыполненныеКлиентуРаботыОстаткиИОбороты.СуммаКОплатеРасход КАК СуммаКОплате
		|ИЗ
