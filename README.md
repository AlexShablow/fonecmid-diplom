...
## Итоговый DT-файл информационной базы находится в блоке Realeses данного репозитория под именем Release-v002_27-04-2024
...
- [X] В инструкции описывается какие действия следует выполнить в информационной базе,
